...
/***/ function(module, exports) {
	...
	var CONFIG = {
		...
		wordDetailMap: {
			...
			'BILLE EN TÊTE': { type: "image", text: "quelque soit le contextes de foncer bille-en-tête", contentURL: "4-BILLE EN TETE.gif" },
			'CAFÈT': { type: "image", text: "de reprendre (juste un peu) de frites à la cafèt", contentURL: "5-CAFET.gif" },
			...
			'RACLETTE TARTIFLETTE': { type: "image", text: "de passer l’hiver entre raclettes et tartiflettes", contentURL: "9-RACLETTE_TARTIFLETTE.gif" },
			...
			'FACETTE': { type: "image", text: "de me prendre pour Beyonce dès qu’il y a une boule à facettes", contentURL: "13-FACETTE.gif" },
			...
			'CHANSONNETTE': { type: "image", text: "passé 4h du mat’ de pousser la chansonnette", contentURL: "18-CHANSONNETTE.gif" },
			...
			'MAGNÉTOCASSETTE': { type: "video", text: "de garder «juste au cas où» mon magnétocassette", contentURL: "https://www.youtube.com/watch?v=5hb1McPIIyE" },
			...
			'TROTINETTE': { type: "image", text: "de trouver stylé les déplacements en trottinette", contentURL: "28-TROTINETTE.gif" },
			...
			'PAILLETTE': { type: "image", text: "d’éssayer de faire valider pour la 1000e fois le motif paillette", contentURL: "32-PAILLETTE.gif" },
			...
			'FÊTE': { type: "image", text: "d’arriver «discretement» apres un lendemain de fête", contentURL: "34-FETE.gif" },
			'FRANCE CONNECT': { type: "image", text: "D’espérer que tout le monde connaisse «FRANCE CONNECT»", contentURL: "35-FRANCE_CONNECT.gif" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WordSlider = __webpack_require__(300);
	...
	var _SocialLinks = __webpack_require__(306);
		...
		var MainApp = function () {
			...
			_createClass(MainApp, [{
				...
				value: function _start() {
					if (SELECT_PHRASE === "") {
						_Emitter2.default.invoke(_constants.EVENTS.PLAY_WORD_SLIDER);
					} else {
						_Emitter2.default.invoke(_constants.EVENTS.RESOLUTION_WINNER, SELECT_PHRASE);
					}
				}
			}, {
				key: "_tick",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OVERLAP_TIME_TEXTS = 0;
	
	var DELAY_DURATION = 8435;
	var FINAL_SPEED = 1000;
	var DECREASE_SPEED = 1.5;
	...
	var WordSlider = function () {
		function WordSlider() {
			...
			_Emitter2.default.subscribe(_constants.EVENTS.PLAY_WORD_SLIDER, function () {
				return _this.start();
			});
		}
		...
		_createClass(WordSlider, [{
			...
			value: function _handleResize() {
				...
				if (this._currentWidth >= _constants.RESPONSIVE_WIDTH_ARRAY[0]) {
					newFontSize = FONT_SIZE_MAP[_constants.RESPONSIVE_WIDTH_ARRAY[0]];
				} else {
					for (var i = 0; i < _constants.RESPONSIVE_WIDTH_ARRAY.length; i++) {
			...
			value: function update(timeDelta, timestamp) {
				...
				if (this._isActive) {
					...
					if (this._startDecreasingSpeed && timestamp - this._startDecreasingSpeed > DELAY_DURATION) {
						...
						this._isActive = false;
						setTimeout(function () {
							return _Emitter2.default.invoke(_constants.EVENTS.RESOLUTION_WINNER, _this2._textArr[_this2._currentText]._text);
						}, DELAY_BEFORE_SHOW_DETAIL);
					}
				}
			...
			value: function draw(ctx, canvas) {
				for (var i = 0; i < this._textArr.length; i++) {
					var currentText = this._textArr[i];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Property = __webpack_require__(302);
	...
	var globalEmitter = function () {
		var Emitter = function () {
			...
			_createClass(Emitter, [{
				...
				key: "subscribe",
				value: function subscribe(eventName, callback, priority) {
					var id = this._getEventId();
					priority = priority || Number.MAX_VALUE;
					var event = { id: id, callback: callback, priority: priority, eventName: eventName };
				...
				value: function invoke(eventName) {
					...
					this._events[eventName].forEach(function (value) {
						return value.callback.apply(value, [value].concat(other));
					});
				}
			}, {
				key: "_redefinePriorities",
				value: function _redefinePriorities(eventName, priority) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DetailContainer = function () {
		function DetailContainer() {
			...
			_Emitter2.default.subscribe(_constants.EVENTS.RESOLUTION_WINNER, function (e, text) {
				return _this.showContainer(text);
			});
		...
		_createClass(DetailContainer, [{
			key: "showContainer",
			value: function showContainer(text) {
						...
						while (1) {
							switch (_context.prev = _context.next) {
								case 0:
									...
									_context.next = 6;
									return this._slideOutContainer();
			...
			value: function () {
							...
							switch (_context2.prev = _context2.next) {
								case 0:
									...
									return new Promise(function (resolve) {
										_this2._image = new Image();
										_this2._image.src = '/images/' + _this2._currentDetail.contentURL;
										_this2._image.onload = resolve;
									});
				...
				function _loadImageContainer() {
					return _ref2.apply(this, arguments);
				}
	
				return _loadImageContainer;
			}()
		}, {
			key: "_loadVideoContainer",
			value: function () {
						...
						while (1) {
							switch (_context3.prev = _context3.next) {
								case 0:
									...
									_context3.next = 3;
									return new Promise(this._loadYouTubeAPIPromise.bind(this));
								...
								case 7:
									_context3.next = 9;
									return this._createVideoInstance();
				...
				function _loadVideoContainer() {
					return _ref3.apply(this, arguments);
				}
	
				return _loadVideoContainer;
			}()
		}, {
			key: "_createVideoInstance",
			value: function _createVideoInstance() {
				var _this3 = this;
	
				return new Promise(function (resolve) {
					var newVideoWrap = document.createElement('div');
					newVideoWrap.id = _this3._mediaContainerId;
					_this3._videoWrap.innerHTML = "";
					_this3._videoWrap.appendChild(newVideoWrap);
	
					_this3._videoPlayer = new YT.Player(_this3._mediaContainerId, {
						width: '100%',
						height: '100%',
						videoId: DetailContainer.getYoutubeURL(_this3._currentDetail.contentURL),
						playerVars: {
							controls: 0,
							loop: 1,
							showinfo: 0,
			...
			key: "_slideOutContainer",
			value: function _slideOutContainer() {
				var _this4 = this;
	
				return new Promise(function (resolve) {
					_this4._body.className = '';
					setTimeout(resolve, 1000);
				});
			}
		}, {
			key: "_slideInContainer",
			value: function _slideInContainer() {
				var _this5 = this;
	
				return new Promise(function (resolve) {
					_this5._body.className = 'slide-in';
					setTimeout(resolve, 1000);
				});
			}
		}, {
			key: "_loadYouTubeAPIPromise",
			value: function _loadYouTubeAPIPromise(resolve, reject) {
			...
			key: "getYoutubeURL",
			value: function getYoutubeURL(url) {
